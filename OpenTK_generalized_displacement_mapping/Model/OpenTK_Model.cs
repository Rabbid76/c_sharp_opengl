...
namespace OpenTK_generalized_displacement_mapping.Model
{
    /// <summary>
        ...
        : IDisposable
    {
        ...
        public void Setup(int cx, int cy)
        {
            ...
            this._parallax_prog = OpenTK_library.OpenGL.Program.VertexGeometryFragmentShaderProgram(vert_shader, geo_shader, frag_shader);
